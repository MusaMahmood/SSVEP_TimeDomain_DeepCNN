...
for win_len in wlens:
    ...
    BIAS_VAR_CL3 = 96  # Number of kernel convolutions in h_conv2
    BIAS_VAR_CL4 = 128  # Number of kernel convolutions in h_conv2
    ...
    # The input should be shaped/flattened to fully connect
