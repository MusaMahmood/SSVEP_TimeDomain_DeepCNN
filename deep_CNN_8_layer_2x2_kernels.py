...
for win_len in wlens:
    ...
    BIAS_VAR_CL5 = 128  # Number of kernel convolutions in h_conv1
    BIAS_VAR_CL6 = 128  # Number of kernel convolutions in h_conv2
    BIAS_VAR_CL7 = 128  # Number of kernel convolutions in h_conv2
    BIAS_VAR_CL8 = 128  # Number of kernel convolutions in h_conv2

    WEIGHT_VAR_CL1 = [2, 2, 1, BIAS_VAR_CL1]  # # [filter_height, filter_width, in_channels, out_channels]
    WEIGHT_VAR_CL2 = [2, 2, BIAS_VAR_CL1, BIAS_VAR_CL2]  # # [filter_height, filter_width, in_channels, out_channels]
    WEIGHT_VAR_CL3 = [2, 2, BIAS_VAR_CL2, BIAS_VAR_CL3]
    WEIGHT_VAR_CL4 = [2, 2, BIAS_VAR_CL3, BIAS_VAR_CL4]

    WEIGHT_VAR_CL5 = [2, 2, BIAS_VAR_CL4, BIAS_VAR_CL5]
    WEIGHT_VAR_CL6 = [2, 2, BIAS_VAR_CL5, BIAS_VAR_CL6]
    WEIGHT_VAR_CL7 = [2, 2, BIAS_VAR_CL6, BIAS_VAR_CL7]
    WEIGHT_VAR_CL8 = [2, 2, BIAS_VAR_CL7, BIAS_VAR_CL8]
    ...
    def export_model(input_node_names, output_node_name_internal):
        freeze_graph.freeze_graph(EXPORT_DIRECTORY + MODEL_NAME + '.pbtxt', None, False,
                                  EXPORT_DIRECTORY + MODEL_NAME + '.ckpt', output_node_name_internal,
                                  "save/restore_all",
